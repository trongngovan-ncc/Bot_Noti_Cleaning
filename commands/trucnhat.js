  ...
  try {
    ...
    const embedElement = {
      ...
      description: [
        ...
        "8.  *mrb, *mrb_sapxep, *mrb_donuocthai, *mrb_dorac: Xem hướng dẫn sử dụng, sắp xếp bát đũa, đổ nước thải, đổ rác cho máy rửa bát",
        "9.  *phongderac: Xem hướng dẫn đi đến phòng đổ rác.",
        "```",
        "",
      ].join('\n'),
